    ...
    props: [
      {
        ...
        description:
          "The text or element to display with the blur hover effect",
      },
      {
        name: "blurRadius",
        type: "number",
        required: false,
        defaultValue: "4",
        description: "How much blur to apply initially (in px)",
      },
      {
        name: "className",
        type: "string",
        required: false,
        defaultValue: undefined,
        description: "Extra Tailwind/utility classes for customization",
      },
      {
        name: "duration",
        type: "number",
    ...
    props: [
      {
        ...
        required: true,
        defaultValue: undefined,
        description: "Content to display with the sparkle effect",
      },
      {
        name: "className",
        type: "string",
      ...
      },
      {
        ...
        required: false,
        defaultValue: "15",
        description: "Number of sparkle particles to show",
      },
      {
        name: "duration",
        type: "number",
        required: false,
        defaultValue: "3",
        description: "Duration of one sparkle animation cycle in seconds",
      },
    ],
  },
];
